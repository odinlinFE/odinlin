// [AG_GRID_LOCALE_EN](https://www.ag-grid.com/examples/localisation/localisation/locale.en.js)
export default {
  // Set Filter
  ...
  copy: '复制',
  ctrlC: 'Ctrl+C',
  copyWithHeaders: '复制单元格及标题',
  copyWithGroupHeaders: '复制单元格及分组标题',
  paste: '粘贴',
  ctrlV: 'Ctrl+V',
  export: '导出',
  csvExport: '导出 CSV 格式',
  excelExport: '导出 Excel 格式',
